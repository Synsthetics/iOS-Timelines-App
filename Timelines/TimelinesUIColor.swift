//
//  TimelinesUIColor.swift
//  Timelines
//
//  Created by Rodney Sampson on 10/22/16.
...
extension UIColor {
    ...
    static var timelines_backgroundLight: UIColor {
    ...
    static var timelines_tabBarTintColor: UIColor  {
    ...
    static var timelines_buttonTint: UIColor  {
        return UIColor(red:0.94, green:0.95, blue:0.97, alpha:1.00)
    }
